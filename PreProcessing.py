...
df_Hasil.to_csv('Fix_Hasil_ICA.csv', index=False)  # Ganti nama file sesuai kebutuhan

# FILTER OUTLIER REMOVER (Independet Component Analys)

df = pd.read_csv("Fix_Hasil_ICA.csv")
...
df_cleaned.to_csv("Fix_Hasil_PREPROCESSING.csv", index=False)
